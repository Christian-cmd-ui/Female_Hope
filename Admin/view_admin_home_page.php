...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">        
      ...
      <a class="navbar-brand text-dark" href="#myPage"><strong>Female_Hopes</strong></a>
    <div class="collapse navbar-collapse" id="myNavbar">             
      <ul class="nav navbar-nav navbar-right">
          

<li><a href='display_user.php'>Display All Victims List</a></li>
  <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Psychologists<span class="caret"></span></i></a>
          <ul class="dropdown-menu"> 
<li><a href='doctor_name_display.php'> Psychologist Name display</a></li>

<li><a href='add_doctor.php'> Add Members/Psychologist</a></li>
        </ul>
        </li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" >
      <div class="item active">
        <img src="../pic/Pic4.jpg" alt="img1" width="1500" height="800" title="Admin Home Page">
